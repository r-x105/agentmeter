...
void display_hal_begin(void) {
    // 80 MHz rather than the library's 40 MHz default. Worth ~11 ms/frame; the
    // panel push does not scale with the clock beyond this because it is bound
    // by reading the draw buffer out of PSRAM, not by the bus.
    gfx->begin(80000000);
